...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    # torch.save(model, '20171106_img_min_224_raw_negative_712_89_positive_453_57_densenet_121_batch_32_sgd_1e3_step_5_epoch_25_train_.pth')
    torch.save(model, '20171106_img_min_224_flip_negative_1424_89_positive_906_57_densenet_121_batch_32_sgd_1e3_step_5_epoch_25_train_.pth')
    return model
...
model_ft.last_layer = nn.Linear(100, 2)
